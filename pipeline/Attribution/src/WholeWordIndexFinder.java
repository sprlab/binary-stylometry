...
//        String regex = "\\b"+keyword+"\\b";
        ...
        try {
        	// trying pattern.literal instead of fragile escaping
        ...
        //	System.out.println("Pattern created: "+pattern.pattern());
        	...
        	// Added to deal with the pattern '\0'
        	if(regex.contains("\\")) {
        		String[] parts = regex.split("\\\\");
        		regex = String.join("\\\\", parts);
        		System.out.println("Revised regex: " + regex);
        	...
        	{
             regex = "\\"+keyword;
             System.out.println("Revised string: " + regex);
        	 pattern = Pattern.compile(regex);        
             matcher = pattern.matcher(searchString);
        	        }
        }
