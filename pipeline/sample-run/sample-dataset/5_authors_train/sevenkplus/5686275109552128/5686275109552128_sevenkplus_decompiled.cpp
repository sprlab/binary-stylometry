...
// 8048520: using guessed type int _gmon_start__(void);
...
// 8048533: positive sp value 4 has been found
...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  for ( i = 1; i <= v4; ++i )
  {
    ...
    for ( j = 0; j < n; ++j )
    {
      std::istream::operator>>(&std::cin, 4 * j + 134521056);
      v8 += a[j];
    }
    v13 = (v8 - 1) / n + 1;
    v5 = 1000;
...
// 804A0E0: using guessed type int a[1010];
// 804B0A8: using guessed type int n;
